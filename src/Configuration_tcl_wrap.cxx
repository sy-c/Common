...
#define SWIGTYPE_p_ConfigFile swig_types[0]
...
#define SWIG_init    Configuration_Init
#define SWIG_name    "configuration"
#define SWIG_prefix  ""
...
#endif
SWIGINTERN int
_wrap_new_ConfigFile(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ConfigFile *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_ConfigFile ") == TCL_ERROR) SWIG_fail;
  {
    try {
  ...
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_ConfigFile,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_ConfigFile(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ConfigFile *arg1 = (ConfigFile *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_ConfigFile self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_ConfigFile, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN int
_wrap_ConfigFile_load(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ConfigFile *arg1 = (ConfigFile *) 0 ;
  std::string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"oo:ConfigFile_load self path ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_ConfigFile, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConfigFile_load" "', argument " "1"" of type '" "ConfigFile *""'"); 
  }
  arg1 = reinterpret_cast< ConfigFile * >(argp1);
  {
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "ConfigFile_load" "', argument " "2"" of type '" "std::string const""'"); 
    }
    arg2 = *ptr;
...
SWIGINTERN int
_wrap_ConfigFile_getValue(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ConfigFile *arg1 = (ConfigFile *) 0 ;
  std::string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:ConfigFile_getValue self std::string const ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_ConfigFile, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConfigFile_getValue" "', argument " "1"" of type '" "ConfigFile *""'"); 
  }
  arg1 = reinterpret_cast< ConfigFile * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string SWIG_TCL_CALL_ARGS_2(objv[2], &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "ConfigFile_getValue" "', argument " "2"" of type '" "std::string const""'"); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  {
    try {
      result = (arg1)->SWIGTEMPLATEDISAMBIGUATOR getValue< std::string >(arg2);
    } catch (const std::string& e) {
      SWIG_exception(SWIG_RuntimeError, e.c_str());
    }
  }
...
SWIGINTERN void swig_delete_ConfigFile(void *obj) {
ConfigFile *arg1 = (ConfigFile *) obj;
delete arg1;
}
static swig_method swig_ConfigFile_methods[] = {
    {"load", _wrap_ConfigFile_load}, 
    {"getValue", _wrap_ConfigFile_getValue}, 
    {0,0}
};
static swig_attribute swig_ConfigFile_attributes[] = {
    {0,0,0}
};
static swig_class *swig_ConfigFile_bases[] = {0};
static const char * swig_ConfigFile_base_names[] = {0};
static swig_class _wrap_class_ConfigFile = { "ConfigFile", &SWIGTYPE_p_ConfigFile,_wrap_new_ConfigFile, swig_delete_ConfigFile, swig_ConfigFile_methods, swig_ConfigFile_attributes, swig_ConfigFile_bases,swig_ConfigFile_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "new_ConfigFile", (swig_wrapper_func) _wrap_new_ConfigFile, NULL},
    { SWIG_prefix "delete_ConfigFile", (swig_wrapper_func) _wrap_delete_ConfigFile, NULL},
    { SWIG_prefix "ConfigFile_load", (swig_wrapper_func) _wrap_ConfigFile_load, NULL},
    { SWIG_prefix "ConfigFile_getValue", (swig_wrapper_func) _wrap_ConfigFile_getValue, NULL},
    { SWIG_prefix "ConfigFile", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_ConfigFile},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_ConfigFile = {"_p_ConfigFile", "ConfigFile *", 0, 0, (void*)&_wrap_class_ConfigFile, 0};
...
SWIGEXPORT int Configuration_SafeInit(Tcl_Interp *interp) {
